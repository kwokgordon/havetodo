...
class TaskCommentsControllerTest < ActionController::TestCase
  ...
  test "should create task_comment" do
    assert_difference('TaskComment.count') do
      post :create, task_comment: { comment: @task_comment.comment, task_id: @task_comment.task_id, user_id: @task_comment.user_id, user_name: @task_comment.user_name }
    end
  ...
  test "should update task_comment" do
    patch :update, id: @task_comment, task_comment: { comment: @task_comment.comment, task_id: @task_comment.task_id, user_id: @task_comment.user_id, user_name: @task_comment.user_name }
    assert_redirected_to task_comment_path(assigns(:task_comment))
  end
